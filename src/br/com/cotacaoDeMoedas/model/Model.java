...
public class Model implements Subject {
	...
	public Boolean excluirMoedas(){		
		...
		if(result.size() != 0){
			...
			//Verifica se a ultima consulta na API e igual ao armazenado no banco
			if( moeda.getUltimaConsulta() != listMoedas.get(0).getUltimaConsulta()){
				...
				System.out.println("\nOs dados est�o atualizados. Nada foi excluido!");
			}
		}else{
			System.out.println("\nO bd est� vazio. Novos dados ser�o adicionados.");
			return true;
		}
