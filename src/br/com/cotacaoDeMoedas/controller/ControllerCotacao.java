...
import br.com.conversaoMoedas.Cotacao;
...
//		model.listaMoedas();
	...
	//Busca os dados da moeda selecionada de acordo com a identificao do index
	public void pesquisar(int index){	

		
		//Dados do db4o
		Moeda mc = (Moeda) model.moedaEspecifica(index);
